...
* `nventiveux/syncthing`
  * `latest`, `v1.4.2` ([Dockerfile.amd64](Dockerfile.amd64))
  * `latest-arm32v6`, `v1.4.2-arm32v6` ([Dockerfile.arm32v6](Dockerfile.arm32v6))
...
Example: new syncthing release v2.2.4 is released but current version of the image is v1.4.2:
